...
final class Test {
	...
	public static void main(String[] args) {
		...
		tester.test("One Comment On One Line", lines("note \"my comment\";"), new TestCriteria() {
			@Override
		...
		tester.test("Two Comments One Line No Space", lines("note \"comment 1\"\"comment 2\";"), new TestCriteria() {
			@Override
			public void onTestEnd(CallTable calls) throws Exception {
		...
		tester.test("Two Comments One Line With Space", lines("note \"comment 1\" \"comment 2\";"), new TestCriteria() {
			@Override
			public void onTestEnd(CallTable calls) throws Exception {
				calls.assertNext("note", "comment 1", "comment 2");
				calls.assertEnd();
		...
		tester.test("Two Comments Two Lines", lines("note \"comment 1\"", "     \"comment 2\";"), new TestCriteria() {
			@Override
			public void onTestEnd(CallTable calls) throws Exception {
				calls.assertNext("note", "comment 1", "comment 2");
				calls.assertEnd();
		...
		tester.test("Print One String", lines("print \"hello\";"), new TestCriteria() {
			@Override
			public void onTestEnd(CallTable calls) throws Exception {
		...
		tester.test("Print Two Strings", lines("print \"hello\" \"world\";"), new TestCriteria() {
			@Override
			public void onTestEnd(CallTable calls) throws Exception {
		...
		tester.test("Print On Different Lines", lines("print \"hello\";", "print \"world\";"), new TestCriteria() {
			@Override
			public void onTestEnd(CallTable calls) throws Exception {
				calls.assertNext("print", "hello");
		...
		tester.test("Assign variable as constant", lines("let x = 5;"), new TestCriteria() {
			@Override
			public void onTestEnd(CallTable calls) throws Exception {
		...
		tester.test("Adding two constant", lines("let x = 5 + 3;", "print x;"), new TestCriteria() {
			@Override
			public void onTestEnd(CallTable calls) throws Exception {
		...
		tester.test("Subtract two constant", lines("let x = 5 - 3;", "print x;"), new TestCriteria() {
			@Override
			public void onTestEnd(CallTable calls) throws Exception {
		...
		tester.test("Add two variables", lines("let x = 5;", "let y = 3;", "let z = x + y;", "print z;"),
				new TestCriteria() {
					@Override
					public void onTestEnd(CallTable calls) throws Exception {
						calls.assertNext("let", new AddOperation(5));
		...
		tester.test("Subtract two variables", lines("let x = 5;", "let y = 3;", "let z = x - y;", "print z;"),
				new TestCriteria() {
					@Override
					public void onTestEnd(CallTable calls) throws Exception {
						calls.assertNext("let", new AddOperation(5));
		...
		tester.test("Add negative constant to variable", lines("let x = 5;", "let y = x + -3;", "print y;"),
				new TestCriteria() {
					@Override
					public void onTestEnd(CallTable calls) throws Exception {
						calls.assertNext("let", new AddOperation(5));
		...
		tester.test("Math with no spaces", lines("let x=5+3;", "print x;"), new TestCriteria() {
			@Override
			public void onTestEnd(CallTable calls) throws Exception {
				calls.assertNext("let", new AddOperation(5), new AddOperation(3));
				calls.assertNext("print", "8.0"); // use print to verify result
